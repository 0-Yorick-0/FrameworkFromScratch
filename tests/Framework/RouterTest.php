...
class RouterTest extends TestCase
{
	...
	/**
	 * Fonction de setup lancée automatiquement par PHPUNIT
	*/ 
	...
	public function testGetMethodWithParameters()
	{
		...
		//Test invalid url
		$route = $this->router->match(new ServerRequest('GET', '/blog/mon_article-8'));
		$this->assertEquals(null, $route);
	}

	public function testGenerateUri()
	{
		$this->router->get('/blog', function () { return 'nimp'; }, 'posts');
		$this->router->get('/blog/{slug:[a-z0-9\-]+}-{id:\d+}', function () { return 'hello'; }, 'post.show');
